 ...
 * their projection without a follow-up API fetch. Heavy fields (template content, variables schema)
 * stay out — consumers that need them call template-service directly.
 */
public final class TemplateEvents {
  ...
  public record TemplateDraftSaved(UUID templateId, UUID editorUserId, Instant occurredAt) {}
