package cz.komercpoj.tmpmgmt.template.config;
...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(a -> a
                        ...
                        .requestMatchers("/actuator/prometheus").permitAll() // scrape endpoint
    ...
    /** Keycloak puts realm roles under {@code realm_access.roles}. Map each to {@code ROLE_X}. */
