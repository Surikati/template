...
class QuestionnaireLifecycleIT {
  ...
  void fullLifecycle_structure_and_session() {
                    ...
                    new QuestionnaireCommands.SectionInput(
                        ...
                        List.of(
                            new QuestionnaireCommands.QuestionInput(
                                ...
                                null),
                            new QuestionnaireCommands.QuestionInput(
                                1, "client.ico", "IČO", QuestionType.TEXT, null, null, null))),
                    new QuestionnaireCommands.SectionInput(
                        1,
                        "Podmínky",
                        null,
    ...
    var updated =
        questionnaires.replaceStructure(
    ...
    sessions.submitAnswers(
        new QuestionnaireCommands.SubmitAnswers(
  ...
  void createDuplicateForSameTemplateVersion_throwsConflict() {
    UUID templateId = UUID.randomUUID();
    questionnaires.create(
        new QuestionnaireCommands.CreateQuestionnaire(templateId, 1, "Q1", List.of()));
    assertThatThrownBy(
            () ->
                questionnaires.create(
                    new QuestionnaireCommands.CreateQuestionnaire(templateId, 1, "Q2", List.of())))
  ...
  void submitAfterComplete_throwsConflict() {
    ...
    QuestionnaireEntity q =
        questionnaires.create(
            new QuestionnaireCommands.CreateQuestionnaire(templateId, 1, "Q", List.of()));
    ...
    assertThatThrownBy(
            () ->
                sessions.submitAnswers(
                    new QuestionnaireCommands.SubmitAnswers(session.getId(), Map.of("foo", "bar"))))
        .isInstanceOf(ConflictException.class);
  }
}
