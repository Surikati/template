...
public final class QuestionnaireEvents {
  ...
  public record QuestionnaireUpdated(UUID questionnaireId, int sectionCount, Instant occurredAt) {}
  ...
  public record SessionCompleted(
      UUID sessionId, UUID questionnaireId, UUID startedBy, JsonNode answers, Instant occurredAt) {}
}
