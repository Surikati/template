...
public class QuestionnaireSessionController {
    ...
    public ResponseEntity<SessionResponse> start(
        ...
        var session = service.start(new QuestionnaireCommands.StartSession(
                req.questionnaireId(), currentUserId(jwt)));
    ...
    public SessionResponse submitAnswers(
        ...
        return mapper.toResponse(service.submitAnswers(
                new QuestionnaireCommands.SubmitAnswers(id, req.answers())));
    }
