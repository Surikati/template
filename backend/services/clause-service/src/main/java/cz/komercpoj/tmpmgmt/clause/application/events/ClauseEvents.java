...
/**
 * See {@link cz.komercpoj.tmpmgmt.template.application.events.TemplateEvents} for the rationale on
 * event-carried state — same pattern: metadata in the event, heavy content fetched on demand.
 */
