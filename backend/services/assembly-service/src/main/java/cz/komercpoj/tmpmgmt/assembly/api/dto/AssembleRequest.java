...
/**
 * {@code formats} is a list because a single contract is often shipped as both an editable DOCX
 * and an archival PDF — generating both in one job avoids re-resolving clauses + re-rendering.
 * Defaults to {@code [DOCX]} when omitted, preserving the prior single-format behavior.
 */
