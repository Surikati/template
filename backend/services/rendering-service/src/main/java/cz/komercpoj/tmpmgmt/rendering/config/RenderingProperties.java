 ...
 * deployer — this repo intentionally does not ship a binary font asset. If unset, PDF generation
 * falls back to PDFBox built-in fonts, which lack Czech diacritics support.
 */
